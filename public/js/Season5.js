...
function x(){
$.ajax({
	url: "https://www.omdbapi.com/?t=The walking dead season 5"
}).done(function(res){
	console.log(res);
	let html = `
	   <center>
		<h1>${res.Title}</h1>
		<img src="${res.Poster}"/>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/Fkh5ufGrpq0" frameborder="0" allowfullscreen></iframe>
		<div id="container">
		<div id="center">
		<h3>Type: ${res.Type}</h3>
